...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfMarkCategorySynced;
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `categories` (`id`,`name`,`icon`,`isDefault`,`serverId`,`isSynced`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getServerId() == null) {
          ...
          statement.bindLong(5, entity.getServerId());
        }
    ...
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`icon` = ?,`isDefault` = ?,`serverId` = ?,`isSynced` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfMarkCategorySynced = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE categories SET serverId = ?, isSynced = 1 WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object markCategorySynced(final int localId, final int serverId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfMarkCategorySynced.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfMarkCategorySynced.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategoryEntity(_tmpId,_tmpName,_tmpIcon,_tmpIsDefault,_tmpServerId,_tmpIsSynced);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getUnsyncedCategories(
      final Continuation<? super List<CategoryEntity>> $completion) {
    final String _sql = "SELECT * FROM categories WHERE isSynced = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
